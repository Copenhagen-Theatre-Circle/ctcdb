<template>
    <div>
        <!-- <home-intro v-if="intro" v-on:toggleIntro="intro=false"></home-intro> -->
        <base-layout title="Home" id="div" >
            <div style="height: 01rem"></div>
            <base-carousel></base-carousel>
            <br>
            <newsletter-signup-hero></newsletter-signup-hero>
            <hr>
            <section>
                <div class="hero is-transparent" style="border-bottom: 1px grey solid; margin-bottom: 10px; padding-bottom: 0px;">
                    <div class="columns header">
                        <div class="column">
                            <h1 class="title is-size-3 has-text-white" style="padding-left: 10px;">Calendar<span v-if="eventFilter!='all'">: {{eventFilter}}</span></h1>
                        </div>
                        <div class="column">
                            <div class="field is-horizontal is-pulled-right">
                                <div class="field-label is-normal">
                                   <label class="label has-text-light">Filter Events:</label>
                                 </div>
                                <div class="select">
